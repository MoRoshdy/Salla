    ...
    return BlocConsumer<ShopCubit, ShopStates>(
      ...
      builder: (context, state) {
        return ConditionalBuilder(
          condition: ShopCubit.get(context).homeModel != null && state is! ShopLoadingCategoriesState,
          builder: (context) =>
                    ...
                    Row(
                      children: [
                        ...
                        IconButton(
                          ...
                          icon: CircleAvatar(
                            radius: 15.0,
                            backgroundColor: ShopCubit.get(context).carts[model.id] == true ? defaultColor : Colors.grey,
                            child: const Icon(
